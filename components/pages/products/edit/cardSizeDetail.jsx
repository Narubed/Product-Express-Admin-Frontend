...
export default function componentName({ isCardSizeDetail, setCardSizeDetail }) {
  ...
  const [isSizeIndex, setSizeIndex] = useState(0);
  const [isCheckButton, setCheckButton] = useState("create");
  ...
  const handleEditSizeDetail = (e) => {
    console.log("handleEditSizeDetail");
    let newValues = isCardSizeDetail;
    newValues[isSizeIndex].Thai = isSize.Thai;
    newValues[isSizeIndex].Eng = isSize.Eng;
    newValues[isSizeIndex].Cambodia = isSize.Cambodia;
    newValues[isSizeIndex].Myanmar = isSize.Myanmar;
    newValues[isSizeIndex].Laos = isSize.Laos;
    newValues[isSizeIndex].China = isSize.China;
    newValues[isSizeIndex].Cost = isSize.Cost;
    newValues[isSizeIndex].Price = isSize.Price;
    newValues[isSizeIndex].OldPrice = isSize.OldPrice;
    newValues[isSizeIndex].NBA = isSize.NBA;
    newValues[isSizeIndex].Stock = isSize.Stock;
    setCardSizeDetail(newValues);
    setSize({
      Thai: "",
      Eng: "",
            ...
            <Grid item xs={6} sm={4} md={4} lg={4} key={item.Thai}>
              <Card>
                <CardActionArea>
                  ...
                  <Button
                    onClick={() => onClickEditCard({ item, index })}
                    color="secondary"
                    variant="outlined"
                  >
                    แก้ไขการ์ดนี้
